...
const AdminUsersComponent = () => {
  ...
  return (
    <section data-scroll data-scroll-speed=".1" id="AdminUsersSection" className="bg-gray-900 p-4 sm:p-6 rounded-lg">
      <div className="pb-2 border-b-2 border-orange-500 mb-4">
        <h4 className="text-2xl sm:text-3xl font-bold text-white">Users Overview</h4>
      </div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
          {/* Total Users */}
          <div className="bg-gray-800 p-4 sm:p-6 rounded-lg shadow hover:shadow-orange-500/20 transition-all duration-300">
