...
const AdminUsersComponent = () => {
  ...
  return (
    ...
    >
      <div className="pb-2 border-b-2 border-zenos-600 mb-4">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
          {/* Total Users */}
          <div className="bg-gray-800 p-4 sm:p-6 rounded-lg shadow hover:shadow-zenos-600/20 transition-all duration-300">
            <div className="flex items-center">
              <div className="p-3 bg-zenos-600 rounded-lg">
                <i className="text-gray-900 fa-xl fa-solid fa-users"></i>
              </div>
              <div className="ml-4">
          ...
          <div className="bg-gray-800 p-4 sm:p-6 rounded-lg shadow hover:shadow-zenos-600/20 transition-all duration-300">
            <div className="flex items-center">
              <div className="p-3 bg-zenos-600 rounded-lg">
                <i className="text-gray-900 fa-xl fa-solid fa-user-check"></i>
              </div>
              <div className="ml-4">
          ...
          <div className="bg-gray-800 p-4 sm:p-6 rounded-lg shadow hover:shadow-zenos-600/20 transition-all duration-300">
            <div className="flex items-center">
              <div className="p-3 bg-zenos-600 rounded-lg">
                <i className="text-gray-900 fa-xl fa-solid fa-user-clock"></i>
              </div>
              <div className="ml-4">
