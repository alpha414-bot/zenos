...
const About = () => {
  ...
  return (
    <MainLayout>
      <PageMeta
        title="About Us"
        description="Welcome to Zenos, your one-stop
        ...
        <div className="px-5 py-10 space-y-12 md:px-10">
          <div>
            ...
            <div className="mt-2 font-normal">
              ...
              destination for all things tech! Whether you're in the market for
              a new laptop, the latest mobile phone, or cutting-edge gadgets,
              ...
              . Inspired by the innovation and creativity fostered by Chameleon
              AI building platform, we strive to bring those values into our
              store, providing our customers with not just products, but a
              commitment to quality and excellence. Thank you for choosing{" "}
              <strong> Zenos Tech Store</strong>. We're here to help you find
              the perfect tech solutions to meet your needs. Happy shopping!
            </div>
          </div>
          <div>
