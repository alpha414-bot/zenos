...
import { default as AwsImage, default as ImageAnime } from "@/Components/ImageAnime";
  ...
  return (
    ...
    >
      <div className="space-y-5">
        <div className="relative flex flex-col items- justify-between py-20 gap-8 min-h-[25rem] md:flex-row md:min-h-[30rem] md:py-28">
          ...
          <div className="absolute -z-10 w-full top-0 md:right-0">
            <ImageAnime
              // path="hero.svg"
              height={25}
              typeOfCanva="globe"
